...
exports.insertOfficer = void 0;
const index_1 = require("../index");
function insertOfficer() {
    const statement = index_1.db.prepare("INSERT INTO officers (name,email,phone) VALUES(?,?,?)");
    ...
    const detailes = [
        ...
        [
            "Christoffer Chastagnier",
            "cchastagnier4@cyberchimps.com",
            "407-392-0683",
        ],
...
exports.insertOfficer = insertOfficer;
// export function initData() {
//   const query = readFileSync(cwd() + "/officers.sql", "utf8");
